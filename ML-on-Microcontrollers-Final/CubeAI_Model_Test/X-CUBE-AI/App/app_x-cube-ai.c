...
int acquire_and_process_data(ai_i8* data[])
{
  ...
  */
  HAL_UART_Receive(&huart1, (uint8_t*)ai_input->data, 32*32*3, HAL_MAX_DELAY);
  HAL_Delay(1000);
  HAL_UART_Transmit(&huart1, (uint8_t*)ai_input->data, 32*32*3, HAL_MAX_DELAY);
  HAL_Delay(1000);
  return 0;
}
...
int post_process(ai_i8* data[])
{
  ...
  */
  HAL_UART_Transmit(&huart1, (uint8_t*)ai_output->data, 10, HAL_MAX_DELAY);
  return 0;
}
/* USER CODE END 2 */
